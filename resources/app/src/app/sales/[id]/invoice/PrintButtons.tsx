...
// Client Component: Print/Export toolbar for sales invoices.
// Includes WhatsApp sharing via the backend Socket.IO + REST API.
...
import {
  ...
  CheckCircle2, AlertCircle, Loader2, Wifi, WifiOff, ExternalLink, Copy
} from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="print-toolbar print-hidden" style={{ display: 'flex', gap: '12px', justifyContent: 'space-between', padding: '16px 24px', background: 'var(--c-bg-card)', borderBottom: '1px solid var(--c-border)', marginBottom: '24px', borderRadius: '8px', boxShadow: 'var(--shadow-sm)', border: '1px solid var(--c-border)' }}>
        <Link href="/sales" className="btn-secondary" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', textDecoration: 'none', fontSize: '0.9rem' }}>
          <ArrowLeft size={16} />
